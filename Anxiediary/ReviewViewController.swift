...
class ReviewViewController: UIViewController {
    ...
    func setText() {
        ...
        if goodPosts > 28  {
            reviewText.text = "This month has been almost immaculate, you've almost passed a whole month without ANY bad days! Speak to your counsellor about why this month has been so great for you and try and outline what could have made it even better. Make sure you celebrate in whichever way you like. Keep up the good work, hopefully next month is just as good! If you wish to start another month from scratch, please click the reset button on the home screen."
            return
        }
        ...
        if goodPosts > 26 {
            reviewText.text = "Fantastic review! You've been able to continue through the month with a huge positive attitude. Yeah okay, you've had a handful of bad days, but we all do, right? Wherever you are in your journey against fighting anxiety, just make sure that you know that your efforts will never go to waste. You will beat anxiety and stress eventually! If you wish to start another month from scratch, please click the reset button on the home screen."
            return
        }
        
        if goodPosts > 25  {
            reviewText.text = "This month has been great! You've had many more good days than bad. If you're still seeing a counsellor, let them know about your worst day this month and explain why it was negative, so you can work on a clean sheet. You're doing great, keep it up and keep finding those positives! If you wish to start another month from scratch, please click the reset button on the home screen."
            return
        }
        ...
        if goodPosts > 22 {
            reviewText.text = "Its been a fairly good month for you, congratulations! Even though you've had a few bad days, you've still managed to have lots of good days! Keep up the fantastic work and hopefully we will see you next month with even more green in that feed. If you wish to start another month from scratch, please click the reset button on the home screen."
            return
        }
        ...
        if goodPosts > 20  {
            reviewText.text = "Your month scored pretty high, well done you! Your month has been a success. Hopefully at this current time you are able to reflect on your positives rather than dwelling on your negatives like many of us do. Speak to your counsellor about your next step to reducing you anxiety even further. If you wish to start another month from scratch, please click the reset button on the home screen."
            return
        }
        ...
        if goodPosts > 18 {
            reviewText.text = "This month has had quite a few positive days, good job! Try talking to your counsellor about how life is in your student house or indeed at home, perhaps there are improvements to be made there in order to see more green in the feed. Hopefully next month brings better things! If you wish to start another month from scratch, please click the reset button on the home screen."
            return
        }
        ...
        if goodPosts > 16 {
            reviewText.text = "Congratulations, you've had more good days than bad days! But only just. The coming month still needs lots more progress. But you've shown that you can still have a positive attitude to life, so dont give up on yourself! Take each day as it comes and remember to give yourself the respect you deserve every single day. If you wish to start another month from scratch, please click the reset button on the home screen."
            return
        }

        if goodPosts > 15  {
            reviewText.text = "This month has been mostly okay for you, but you've had a few bad days. Try and remember the best experience you had and why. Get your counsellor to reflect on how you can improve those days you weren't so fond of. If you wish to start another month from scratch, please click the reset button on the home screen."
            return
        }
        ...
        if goodPosts > 11 {
            reviewText.text = "This month hasn't been the greatest, but by far the worst. Consider trying to increase your motivation with your education by writing daily plans, as completing plans is a good way to boost your self esteem. Speak to your counsellor about your next step. If you wish to start another month from scratch, please click the reset button on the home screen."
            return
        }

        if goodPosts > 10 {
            reviewText.text = "This month hasn't been your best, but sometimes life isn't always great. You must remember that every single day has a positive, there is always something good to carry over to the next day. Speak to your counsellor about perhaps walking you through your bad days, so together you can work on finding more positives in the days that pass. If you wish to start another month from scratch, please click the reset button on the home screen."
            return
        }
